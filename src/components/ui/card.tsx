...
import { spring } from '::/libs/springs'
import { fontWeights } from '::/libs/font-weight'
import { useShape } from '::/libs/shape-context'
import { SizeProvider, useSize, type SizeVariant } from '::/libs/size-context'
      ...
      <CardContext.Provider value={cardContext}>
        ...
        >
          ...
          {dismissible && (
            ...
            >
              <X size={compact ? 13 : 15} strokeWidth={1.5} />
            </button>
          )}
        </div>
